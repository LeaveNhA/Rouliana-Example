(defproject roulianaexamplexiana "0.1.0-SNAPSHOT"
  ...
  :dependencies [[com.flexiana/framework "0.5.0-rc3"]
                 ...
                 [reagent "0.10.0"]
                 [rouliana "0.1.0-SNAPSHOT"]
                 [day8.re-frame/http-fx "0.2.4"]
                 [re-frame "1.1.2"]]
  :plugins [[lein-shadow "0.4.0"]]
  :main ^:skip-aot roulianaexamplexiana.core
  :uberjar-name "roulianaexamplexiana.jar"
  ...
  :shadow-cljs {:nrepl  {:port 8777}
                ...
                :builds {:app {:target     :browser
                               ...
                               :modules    {:app {:init-fn roulianaexamplexiana.core/init
